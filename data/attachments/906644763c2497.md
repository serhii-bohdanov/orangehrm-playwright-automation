...
- Name: ui/main-page/left-navigation-menu.spec.js >> Left Navigation Menu tests >> Check that left navigation menu is present on the main page
- Location: tests/ui/main-page/left-navigation-menu.spec.js:9:3
